...
const CreditCard = ({ balance='R0.00', cardHolder = 'Thabelo Budeli', cardNumber, expiry, isEven }) => {
    
    return (
            <div className={`card`}>
                <div className={`card text-white rounded-3xl p-6 w-full ${isEven ? 'even' : 'odd'}`}>
                    {/* Top row */}
                    ...
                    <div className="flex justify-between mb-8">
                        ...
                        <p className="text-lg font-bold">{expiry}</p>
                        </div>
                    </div>
                
                    {/* Bottom row */}
                    <div className="flex justify-between items-center">
                        <p className="text-xl font-bold tracking-wider">{cardNumber}</p>
