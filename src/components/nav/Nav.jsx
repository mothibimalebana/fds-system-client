        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
          <g clip-path="url(#clip0_104_137)">
            <path
              ...
              fill={currNav === "Dashboard" ? "#2D60FF" : "#B1B1B1"}
            />
          </g>
          <defs>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
          <g clip-path="url(#clip0_78_393)">
            <path
              ...
              fill={currNav === "Transactions" ? "#2D60FF" : "#B1B1B1"}
            />
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
          <g clip-path="url(#clip0_78_414)">
            <path
              ...
              fill={currNav === "Accounts" ? "#2D60FF" : "#B1B1B1"}
            />
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
          <g clip-path="url(#clip0_78_382)">
            <path
              ...
              fill={currNav === "Investments" ? "#2D60FF" : "#B1B1B1"}
            />
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
          <g clip-path="url(#clip0_78_401)">
            <path
              ...
              fill={currNav === "Loans" ? "#2D60FF" : "#B1B1B1"}
            />
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
          <g clip-path="url(#clip0_78_355)">
            <path
              ...
              fill={currNav === "Services" ? "#2D60FF" : "#B1B1B1"}
            />
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
          <g clip-path="url(#clip0_78_374)">
            <path
              ...
              fill={currNav === "Settings" ? "#2D60FF" : "#B1B1B1"}
            />
          </g>
          <defs>
      ...
      <div className="nav-container flex md:flex-col">
        ...
        <section className="md:hidden w-full">
          <div className="top py-4 w-full">
            <div
              className="nav-menu w-full grid grid-cols-4"
              onClick={() => {
                ...
                {navItems.map((item) => {
                  return (
                    <li key={item.id} className="flex gap-4 uppercase">
                      {item.svg}
                      <Link to="#" onClick={() => setCurrNav(item.text)}>
                        {item.text}
                      </Link>
                    </li>
                  )
